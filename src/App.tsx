  ...
  return (
    <>
      ...
      <div className="mx-auto grid grid-cols-3 gap-2 p-4">
        <div className="border-r-1 border-white bg-slate-950 p-4">
          <BeatmapCard
        ...
        <div className="col-span-2 border-l-1 border-white bg-slate-950 p-4 text-white">
      ...
      <div className="mx-auto grid grid-cols-3 gap-2 p-4">
        <div className="rounded border border-rose-600 bg-slate-950 p-4 text-white">
          <h1>
        ...
        <div className="rounded border border-yellow-400 bg-slate-950 p-4 text-white">
          <h1>
            Vel sapiente sunt quo consequatur corporis est quas laboriosam et
            nemo quia qui omnis repellat quo iste iure. Et soluta voluptatum rem
            quia consectetur sed adipisci exercitationem et blanditiis autem.
        ...
        <div className="rounded border border-green-500 bg-slate-950 p-4 text-white">
          <h1>
            Vel sapiente sunt quo consequatur corporis est quas laboriosam et
            nemo quia qui omnis repellat quo iste iure. Et soluta voluptatum rem
            quia consectetur sed adipisci exercitationem et blanditiis autem.
